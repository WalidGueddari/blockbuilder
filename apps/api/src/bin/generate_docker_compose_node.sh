...
generate_docker_compose_node() {
    ...
    echo "Debug: NODE_INDEX=$NODE_INDEX, P2P_PORT=$P2P_PORT, P2P_HOST=$P2P_HOST, RPC_HTTP_PORT=$RPC_HTTP_PORT, HTTP_HOST=$HTTP_HOST, RPC_WS_PORT=$RPC_WS_PORT, WS_HOST=$WS_HOST, IP= $NODE_IP, ENODE_URL=$ENODE_URL,  TESS_THIRD_PARTY_PORT=$TESS_THIRD_PARTY_PORT, TESS_Q2T_PORT=$TESS_Q2T_PORT, TESS_P2P=$TESS_P2P, TESS_HEALTH_PORT=$TESS_HEALTH_PORT, TESSERA_IP=$TESSERA_IP"
